...
;// CONCATENATED MODULE: ./apis/flight/http/integrator/booking.js
/* global __ENV */

const booking = (params, integrator, request) => {
  params.tags.name = 'booking';
  params.headers['Content-Type'] = 'application/json';
  const resp = http_default().post(`${__ENV.LB_HOST}/${integrator}/booking`, JSON.stringify(request), params);
  return resp;
};
;// CONCATENATED MODULE: ./scenarios/flight/integrator/expressair.js
/* global __ENV */
...
/* harmony default export */ function expressair() {
  ...
  (0,external_k6_namespaceObject.group)('expressair', () => {
