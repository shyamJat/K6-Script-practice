...
;// CONCATENATED MODULE: ./scenarios/payment/paymentcore.js
...
const config = {
  ...
  groupServices: {
    paymentFlow: {
      targetRate: distribute(serverCount, 1500),
      dist: 1
    },
    paymentFlow1: {
      targetRate: distribute(serverCount, 1400),
      dist: 1
    },
    paymentFlow2: {
      targetRate: distribute(serverCount, 1600),
      dist: 1
    },
    paymentFlow3: {
      targetRate: distribute(serverCount, 3500),
      dist: 1
