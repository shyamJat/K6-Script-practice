...
export { DiscountApplyV2,DiscountCashback } from '@generator/payment/core/promoGateway.js'

const serverCount = __ENV.SERVER_COUNT || 1
const config = {
  scenario: __ENV.SCENARIO,
  groupServices: {
    DiscountApplyV2: { targetRate: distribute(serverCount, 10000), dist: 1 },
    DiscountCashback: { targetRate: distribute(serverCount, 10000), dist: 1 },
  }
}
