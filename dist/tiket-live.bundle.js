...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ adminGenerateTickets)
});
...
;// CONCATENATED MODULE: ./apis/tiket-live/http/adminGenerateTicketsGQL.js

const gqlAdminGenerateTickets = (requestData, params) => {
  const body = {
...
;// CONCATENATED MODULE: ./scenarios/tiket-live/adminGenerateTickets.js



/* harmony default export */ function adminGenerateTickets() {
  ...
  const data = {
    eventHash: '2a0f2bd8-6a43-42b6-a12b-10d987962a73',
    // kakak beradik event hash
    viewerLinks: 2
  };
